...
// default argument initializers. They are both viable. Compiler checks 
// arguments one by  one, only to find that both #1 and #2 are viable. Because  
// there is no const conversion, promotion, arithmetic conversion or class-type 
// conversion. Both are exact match! So the poor compiler gets perplexing. It 
// can do nothing but complain to us about it.
